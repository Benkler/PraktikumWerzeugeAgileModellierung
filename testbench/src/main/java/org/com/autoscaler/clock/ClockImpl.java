...
public class ClockImpl implements Clock {
    ...
    private final Logger log = LoggerFactory.getLogger(ClockImpl.class);
    ...
    // Autowired by Spring
    private ClockEventPublisher clockEventPublisher;

    @Autowired
    public ClockImpl(ClockEventPublisher clockEventPublisher) {
